...
<meta name="description" content="La Sainte Bible — accès à la Bible dans de nombreuses langues">
<title>La Sainte Bible — sainte.bible</title>
  ...
  <nav class="navbar navbar-expand-lg top-space navbar-light bg-black header-light fixed-top navbar-boxed" style="top:48.8px;">
    <div class="container-fluid nav-header-container">
      <div class="ps-lg-0 d-flex align-items-center" style="flex:1;min-width:0;">
        <a class="navbar-brand" href="/sainte/">
          <span style="color:#fff; font-size:1.3em; font-family:serif; font-weight:700; letter-spacing:0.02em;">La Sainte Bible</span>
        </a>
      </div>
      <div class="col-auto bg-black menu-order px-lg-0">
        ...
        <div class="bg-black collapse navbar-collapse justify-content-center" id="navbarNav">
          <ul class="navbar-nav alt-font">
            <li class="nav-item"><a href="/sainte/" class="nav-link">Bibles</a></li>
            <li class="nav-item"><a href="https://sainte.bible/terms.php" class="nav-link">Conditions d'utilisation</a></li>
            <li class="nav-item"><a href="https://sainte.bible/contact.php" class="nav-link">Contactez-nous</a></li>
...
<div class="container slim-container">
  ...
  <h1 class="h1-main-title alt-font font-weight-600 text-extra-dark-gray w-95">La Sainte Bible</h1>
  <p style="font-family:sans-serif;font-size:0.95em;color:#555;line-height:1.7;max-width:680px;margin-bottom:0;">
    Ce site donne accès à la Bible dans de nombreuses langues — <strong><?= number_format($numTrans) ?> traductions</strong> en lecture et téléchargement gratuits.<br>
  ...
  <div class="search-bar">
    <input type="text" id="lang-search" placeholder="Rechercher une langue ou un titre… / Search language or title…" oninput="filterTable()">
  ...
  <table class="trans-table">
    <thead>
      <tr>
        <th style="width:20%">Langue / Language</th>
        <th style="width:52%">Titre / Title</th>
...
<?php endwhile; ?>
  ...
  <div id="no-results">No translations matched your search. / Aucune traduction trouvée.</div>
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-12 col-md-3 text-center text-md-start sm-margin-20px-bottom">
          <span style="color:#fff; font-size:1.6em; font-family:serif; font-weight:700;">La Sainte Bible</span>
        </div>
        <div class="col-12 col-md-6 text-center sm-margin-20px-bottom">
          <span class="alt-font font-weight-500 d-inline-block align-middle margin-5px-right text-white">
            ...
            <a href="https://sainte.bible/terms.php">Conditions d'utilisation</a> &nbsp;&nbsp;
            <a href="https://eBible.org/privacy.php">Politique de confidentialité</a></p>
          </span>
        </div>
