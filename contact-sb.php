...
define('SITE_CODE', 'sb');
define('SITE_NAME', 'Solomons.Bible');
define('SITE_URL',  'https://solomons.bible/');
...
$T['en'] = [
  'title'=>'Contact','subtitle'=>'Send a message to the Solomons.Bible team',
...
$T['es'] = [
  'title'=>'Contacto','subtitle'=>'Envía un mensaje al equipo de Solomons.Bible',
...
$T['de'] = [
  'title'=>'Kontakt','subtitle'=>'Senden Sie eine Nachricht an das Solomons.Bible-Team',
...
$T['pt'] = [
  'title'=>'Contato','subtitle'=>'Envie uma mensagem para a equipe do Solomons.Bible',
...
$T['ru'] = [
  'title'=>'Контакт','subtitle'=>'Отправьте сообщение команде Solomons.Bible',
...
$T['zh'] = [
  'title'=>'联系我们','subtitle'=>'向 Solomons.Bible 团队发送消息',
  'step1'=>'第1步 — 这是什么类型的消息？',
  'typo_title'=>'错别字或翻译错误',
...
$T['ar'] = [
  'title'=>'اتصل بنا','subtitle'=>'أرسل رسالة إلى فريق Solomons.Bible',
...
$T['hi'] = [
  'title'=>'संपर्क करें','subtitle'=>'Solomons.Bible टीम को संदेश भेजें',
...
$T['ja'] = [
  'title'=>'お問い合わせ','subtitle'=>'Solomons.Bible チームにメッセージを送る',
...
$T['ko'] = [
  'title'=>'문의하기','subtitle'=>'Solomons.Bible 팀에 메시지 보내기',
...
$T['id'] = [
  'title'=>'Hubungi Kami','subtitle'=>'Kirim pesan ke tim Solomons.Bible',
...
$T['tr'] = [
  'title'=>'İletişim','subtitle'=>'Solomons.Bible ekibine mesaj gönderin',
...
$T['it'] = [
  'title'=>'Contattaci','subtitle'=>'Invia un messaggio al team di Solomons.Bible',
...
$T['vi'] = [
  'title'=>'Liên hệ','subtitle'=>'Gửi tin nhắn cho đội ngũ Solomons.Bible',
...
$T['th'] = [
  'title'=>'ติดต่อเรา','subtitle'=>'ส่งข้อความถึงทีม Solomons.Bible',
...
$T['nl'] = [
  'title'=>'Contact','subtitle'=>'Stuur een bericht naar het Solomons.Bible-team',
...
$T['pl'] = [
  'title'=>'Kontakt','subtitle'=>'Wyślij wiadomość do zespołu Solomons.Bible',
...
$T['uk'] = [
  'title'=>'Зв\'язатися з нами','subtitle'=>'Надішліть повідомлення команді Solomons.Bible',
...
$T['bn'] = [
  'title'=>'যোগাযোগ করুন','subtitle'=>'Solomons.Bible টিমকে একটি বার্তা পাঠান',
...
$T['ur'] = [
  'title'=>'رابطہ کریں','subtitle'=>'Solomons.Bible ٹیم کو پیغام بھیجیں',
...
$T['mr'] = [
  'title'=>'संपर्क करा','subtitle'=>'Solomons.Bible टीमला संदेश पाठवा',
...
$T['te'] = [
  'title'=>'సంప్రదించండి','subtitle'=>'Solomons.Bible బృందానికి సందేశం పంపండి',
...
$T['ta'] = [
  'title'=>'தொடர்பு கொள்ளுங்கள்','subtitle'=>'Solomons.Bible குழுவிற்கு செய்தி அனுப்புங்கள்',
...
$T['sw'] = [
  'title'=>'Wasiliana Nasi','subtitle'=>'Tuma ujumbe kwa timu ya Solomons.Bible',
...
$T['tet'] = [
  'title'=>'Kontaktu','subtitle'=>'Haruka mensajen ba ekipa Solomons.Bible',
...
$T['tpi'] = [
  'title'=>'Kontaktim Mipela','subtitle'=>'Salim tok long tim bilong Solomons.Bible',
...
$T['ilo'] = [
  'title'=>'Makiinnabuyog','subtitle'=>'Mangibaga iti mensahe iti team ti Solomons.Bible',
...
$T['ceb'] = [
  'title'=>'Kontaka Kami','subtitle'=>'Padad-a og mensahe sa team sa Solomons.Bible',
...
$T['km'] = [
  'title'=>'ទំនាក់ទំនង','subtitle'=>'ផ្ញើសារទៅក្រុម Solomons.Bible',
...
$T['ha'] = [
  'title'=>'Tuntuɓi Mu','subtitle'=>'Aika saƙo zuwa ƙungiyar Solomons.Bible',
...
$T['yo'] = [
  'title'=>'Kan Si Wa','subtitle'=>'Fi ifiranṣẹ ranṣẹ si ẹgbẹ Solomons.Bible',
...
$T['ig'] = [
  'title'=>'Kpọtụrụ Anyị','subtitle'=>'Zipu ozi nye ndị otu Solomons.Bible',
...
$T['am'] = [
  'title'=>'አግኙን','subtitle'=>'ለSolomons.Bible ቡድን መልእክት ይላኩ',
...
$T['om'] = [
  'title'=>'Nu Quunnamaa','subtitle'=>'Ergaa gara garee Solomons.Bible ergi',
...
$T['so'] = [
  'title'=>'Nala Xiriir','subtitle'=>'Farriin u dir kooxda Solomons.Bible',
...
<title><?= h($t['title']) ?> — Solomons.Bible</title>
            ...
            <nav class="navbar navbar-expand-lg top-space navbar-light bg-black header-light fixed-top navbar-boxed" style="top: 48.8px;">
                <div class="container-fluid nav-header-container">
                    <div class="col-6 col-lg-2 me-auto ps-lg-0">
                        <a class="navbar-brand" href="https://solomons.bible/">
                            <img src="/images/SolomonsBibleLogo_300.png" data-at2x="/images/SolomonsBibleLogo_300.png" class="default-logo" alt="Logo" height="95">
                            <img src="/images/SolomonsBibleLogo_300.png" data-at2x="/images/SolomonsBibleLogo_300.png" class="alt-logo" alt="Logo" width="0" height="0">
                            <img src="/images/SolomonsBibleLogo_120.png" data-at2x="/images/SolomonsBibleLogo_120.png" class="mobile-logo" alt="Logo" width="0" height="0">
                        </a>
                    </div>
                    <div class="col-auto bg-black menu-order px-lg-0">
                        ...
                        <div class="bg-black collapse navbar-collapse justify-content-center" id="navbarNav">
                            <ul class="navbar-nav alt-font">
                                <li class="nav-item"><a href="https://solomons.bible/" class="nav-link">Welcome</a></li>
...
<?php if ($mailto_url): ?>
  ...
  <p><a href="contact-sb.php?lang=<?= h($uiLang) ?>"><?= h($t['send_another']) ?></a></p>
...
<?php else: ?>
  ...
  <form method="post" action="contact-sb.php?lang=<?= h($uiLang) ?>" id="contact-form">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-md-3 text-center text-md-start sm-margin-20px-bottom">
                    <img class="circle-black-bg" src="/images/Flag_of_the_Solomon_Islands.jpg" data-at2x="/images/Flag_of_the_Solomon_Islands.jpg" alt="Solomon Islands flag">
                </div>
                <div class="col-12 col-md-6 text-center sm-margin-20px-bottom">
                    <span class="alt-font font-weight-500 d-inline-block align-middle margin-5px-right text-uppercase text-white">
                        <p>Site copyright &copy; 2009-2026 <a href="https://eBible.org/">eBible.org</a>.
                        <br/>See each Bible translation's information page for copyright and permissions information for that translation.
                        <br />
